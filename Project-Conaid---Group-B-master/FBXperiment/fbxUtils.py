...
def addCube( pScene , x, y, z, scaling):
    ...
    name = 'myNode x=' + str(x) + ' y=' + str(y) + ' z='+ str(z)
    
    # Create a new node in the scene.
    newNode = fbx.FbxNode.Create( pScene, name )
    ...
    newNode.LclTranslation.Set(fbx.FbxDouble3(x, y, z))
    newNode.LclScaling.Set(fbx.FbxDouble3(scaling,scaling,scaling))        
